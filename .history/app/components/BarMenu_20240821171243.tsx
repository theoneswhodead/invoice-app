...
const BarMenu = () => {
  return (
    <nav className='bg-gray h-[4.5rem] sm:h-[5rem] lg:h-[100vh] lg:w-[6.4375rem] flex justify-between'>
      <div className='flex justify-between w-full'>
        <div className='bg-purple h-[4.5rem] w-[4.5rem] sm:w-[5rem] sm:h-[5rem]  lg:h-[6.4375rem] rounded-r-3xl relative'>
