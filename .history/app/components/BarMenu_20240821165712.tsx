...
const BarMenu = () => {
  return (
    <nav className='bg-gray h-[4.5rem] sm:h-[5rem] flex justify-between'>
      <div className='flex justify-between w-full'>
        <div className='bg-purple h-[4.5rem] w-[4.5rem] sm:w-[5rem] sm:h-[5rem] rounded-r-3xl relative'>
            ...
            <Image 
                ...
                height={26}
                alt="Logo"
                className='absolute top-1/2 left-1/2 translate-y-[-50%] translate-x-[-50%] sm:w-[33px] sm:h-[31px]'
            />
