...
const BarMenu = ({dark}:boolean) => {
  ...
  return (
    <nav className='bg-gray h-[4.5rem] sm:h-[5rem] lg:h-[100vh] lg:w-[6.4375rem] flex lg:flex-col justify-between lg:rounded-r-3xl '>
      <div className='flex lg:flex-col justify-between w-full lg:h-full'>
        <div className='bg-purple h-[4.5rem] w-[4.5rem] sm:w-[5rem] sm:h-[5rem] lg:w-[6.4375rem] lg:h-[6.4375rem] rounded-r-3xl relative'>
            ...
            />
            <div className='bg-light_purple w-[4.5rem] h-[2.25rem] sm:w-[5rem] sm:h-[2.5rem] lg:w-[6.4375rem] lg:h-[3.21875rem] mt-[3.21875rem] rounded-br-3xl rounded-tl-3xl'>
        ...
        <button>
            <Image 
                ...
                height={20}
                alt="Theme Mode"
                className='mx-[1.5rem] my-[1.625rem] hover:cursor-pointer lg:ml-[2.5625rem] lg:mr-[2.625rem] lg:mb-[2rem]'
            />
        </button>
      </div>
